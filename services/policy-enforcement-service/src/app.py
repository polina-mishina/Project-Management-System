...
@app.api_route(
    "/{path_name:path}", methods=["GET", "DELETE", "PATCH", "POST", "PUT", "HEAD", "OPTIONS", "CONNECT", "TRACE"]
)
async def catch_all(request: Request, path_name: str):
    ...
    logger.info(
        'The request will be redirected along the route: %s%s', enforce_result.redirect_service, path_name
    )
